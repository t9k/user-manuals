...
<figure class="screenshot">
  <img alt="create-pvc-s3cfg.png" src="../assets/tasks/manage-storageshim/create-pvc-s3cfg.png" />
</figure>
...
<figure class="screenshot">
  <img alt="view-storageshim.png" src="../assets/tasks/manage-storageshim/view-storageshim.png" />
</figure>

输入持久卷名称、S3 URI（`s3://<your-bucket>`），然后选择 S3 Secret 名称，最后点击右上角的**创建 StorageShim** 完成创建：

<figure class="screenshot">
  <img alt="create-storageshim.png" src="../assets/tasks/manage-storageshim/create-storageshim.png" />
</figure>

在 S3 标签页查看新创建的 StorageShim：

<figure class="screenshot">
  <img alt="new-storageshim.png" src="../assets/tasks/manage-storageshim/new-storageshim.png" />
</figure>
