...
点击其**名称**进入详情页面，可以看到刚才创建的 TensorFlowTrainingJob 的基本信息、状况信息和事件信息：
...
点击上方的**副本**标签页，查看 TensorFlowTrainingJob 的 Pod 信息：
...
点击上方的**资源监测**标签页，查看 TensorFlowTrainingJob 运行过程中使用集群计算资源、网络资源和存储资源的情况：
