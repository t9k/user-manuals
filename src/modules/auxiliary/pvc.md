...
* 了解 [PVC 的概念](https://kubernetes.io/docs/concepts/storage/persistent-volumes/)
* 了解 [PVC 的定义](https://kubernetes.io/docs/reference/kubernetes-api/config-and-storage-resources/persistent-volume-claim-v1/)
